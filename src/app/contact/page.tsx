            ...
            <div className="flex items-center w-full justify-center">
                <p>Vous pouvez nous joindre directement par 
                    <Link href={"tel:06.99.51.22.90"}> téléphone  
                        <svg width="20px" height="20px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="inline ml-1">
                    ...
                    </Link> ou en remplissant le formulaire afin d'obtenir votre devis. Nous vous répondrons le plus rapidement possible.
                </p>
            </div>
