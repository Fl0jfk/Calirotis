...
function Carousel ({ data }:CarouselProps){
    ...
    return (
        <div className="relative flex justify-center items-center w-full max-w-[1000px] h-[600px]">
            {data.map((item, idx) => {
                return (
            ...
            <svg width="50px" height="50px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" onClick={prevSlide} className="absolute left-[1em] cursor-pointer md:hidden sm:hidden">
                <path d="M5 12H19M5 12L11 6M5 12L11 18" stroke="#fff" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
            <svg width="50px" height="50px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" onClick={nextSlide} className="absolute right-[1em] cursor-pointer md:hidden sm:hidden">
