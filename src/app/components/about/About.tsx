...
function About (){
    return (
        <section className="w-full flex flex-col p-6 items-center gap-8" id="about">
            ...
            <div className="flex-col w-full flex items-center rounded-t-xl h-[500px] max-w-[1000px]">
                <div className="w-full h-[55%] sm:h-[40%] relative">
                ...
                <div className="w-full h-[45%] sm:h-[60%] p-8 flex flex-col items-center text-xl bg-gray-700 rounded-b-xl overflow-y-scroll">
                    <p className="text-start w-full">Je suis Martin après plusieurs années en tant que traiteur au sein d&apos;une entreprise.</p>
                    <p className="text-start w-full">J&apos;ai décidé de lancer ma propre affaire, je me suis spécialisé dans la rotisserie.(cochon de lait, mechoui, barbecue géant...)</p>
