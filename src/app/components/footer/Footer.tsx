    ...
    return (
        <footer className="p-4 flex flex-col max-w-[1500px] mx-auto gap-4">
            ...
            <div className="flex w-1/5 mx-auto justify-between sm:w-3/5">
                ...
                <Link href="https://www.facebook.com/profile.php?id=61554143394633&paipv=0&eav=AfaNxaK7foKCCDip7Hm00EMlDUmMPqIlJU2MRpRnJsjIes64m3wQjyOdkgbr90I-Fok" className="hover:scale-[1.1] transition ease-in-out duration-100" target="blank">
                ...
                <Link href="https://g.co/kgs/TZhFK9k" className="hover:scale-[1.1] transition ease-in-out duration-100" target="blank">
